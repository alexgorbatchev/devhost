...
func TestDownloadCaddy(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantLog:              "[devhost] Downloading Caddy for darwin-arm64 from https://caddyserver.com/api/download?os=darwin&arch=arm64...\n[devhost] Caddy downloaded to /tmp/caddy/caddy\n",
		...
		},
		{
			...
			wantLog:              "[devhost] Downloading Caddy for linux-amd64 from https://caddyserver.com/api/download?os=linux&arch=amd64...\n[devhost] Caddy downloaded to /tmp/caddy/caddy\n",
			wantMkdirPath:        "/tmp/caddy",
			wantWriteDestination: "/tmp/caddy/caddy",
			wantWriteMode:        0o755,
		},
		{
			...
			wantLog:              "[devhost] Downloading Caddy for windows-arm from https://caddyserver.com/api/download?os=windows&arch=arm...\n[devhost] Caddy downloaded to /tmp/caddy/caddy.exe\n",
			wantMkdirPath:        "/tmp/caddy",
