...
export function AnnotationQueuePanel(props: IAnnotationQueuePanelProps): JSX.Element | null {
  ...
  return (
    <section aria-label="Annotation queues" class={panelClassName} data-testid="AnnotationQueuePanel">
                  ...
                  return (
                    ...
                    >
                      ...
                      {isEditable ? (
                        ...
                        <div class={css(createReadOnlyCommentStyle(theme))} data-testid="AnnotationQueuePanel--comment">
