...
export function readRequestedMarketingRecordingScenarioIds(
  requestedScenarioIds: readonly string[],
): readonly MarketingRecordingScenarioId[] {
  return requestedScenarioIds.map((scenarioId: string): MarketingRecordingScenarioId => {
