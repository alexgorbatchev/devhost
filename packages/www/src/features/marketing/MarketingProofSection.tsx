  ...
  return (
    <section className="grid gap-4" aria-labelledby="proof-section-title">
      <div className="grid gap-3">
        <h2 id="proof-section-title" className="text-balance text-3xl font-medium leading-tight tracking-[-0.06em] text-foreground sm:text-4xl">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
        {proofGridCards.map((proofCard: IProofCard) => {
          return (
            <article key={proofCard.id} className="rounded-lg border border-border-subtle bg-card p-5 shadow-[var(--shadow-soft)]">
              <div className="grid gap-3">
